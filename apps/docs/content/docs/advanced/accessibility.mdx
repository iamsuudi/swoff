...
- [Debugging](/docs/advanced/debugging) — test accessibility
- [Performance](/docs/advanced/performance) — optimize for assistive tech



- [Testing](/docs/advanced/testing) — include a11y tests in test suite
- [Client Registration](/docs/patterns/client-registration) — ensure errors are accessible
