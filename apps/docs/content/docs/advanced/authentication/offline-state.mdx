...
import { getAuth, isAuthValid } from "./store.js";
import { getCachedUser } from "./user.js";
...
- **Add local security**: [Lock Screen](/docs/advanced/authentication/lock-screen) — PIN/biometric for fully offline apps
- **Queue mutations**: [Mutation Queuing](/docs/advanced/mutation-queuing) — handle writes when offline
- **Review the SW integration**: [SW Integration](/docs/advanced/authentication/sw-integration)
