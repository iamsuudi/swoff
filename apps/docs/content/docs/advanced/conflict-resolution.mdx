...
**Prerequisites:** [Mutation Queuing](/docs/advanced/mutation-queuing) with ID reconciliation and `$synced` tracking.
...
- See [Mutation Queuing](/docs/advanced/mutation-queuing) — the queue that triggers conflict detection
- Review [Data Layer](/docs/core/data-layer) — how query, mutate, reconcile, and invalidate connect
- Learn [Offline-First Architecture](/docs/core/offline-architecture) — where conflict resolution fits
- See [Testing](/docs/advanced/testing) — test conflict scenarios with fake-indexeddb
