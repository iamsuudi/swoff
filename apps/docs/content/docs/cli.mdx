...
- `serviceWorker.autoRegister`, `autoActivate`, `clearRuntimeOnUpdate` are booleans
- `defaultStrategy` is one of the 5 valid strategies
- `navigationMode` is `"spa"` or `"default"`
- `spaEntry` is a string
...
| Feature            | Aliases                 | Flag Enabled      |
| ------------------ | ----------------------- | ----------------- |
| `mutation-queue`   | `mutationqueue`         | `mutationQueue`   |
| `pwa`              | —                       | `pwa`             |
| `cross-tab`        | `crosstab`              | `crossTabSync`    |
| `auth`             | —                       | `auth`            |
| `tag-invalidation` | `taginvalidation`       | `tagInvalidation` |
| `background-sync`  | `backgroundsync`        | `backgroundSync`  |
| `indexeddb`        | —                       | `indexeddb`       |
| `offline`          | —                       | `offline`         |
