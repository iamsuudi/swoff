...
| `fetch/state.{ts\|js}`             | always                                                                        | Global fetch counter (`getFetchCount`)                                                  |
...
| `sw/version.{ts\|js}`              | always                                                                        | `SW_VERSION` constant for cache busting                                                 |
| `adapters/*.tsx`                   | React-based framework (react-spa, nextjs, remix, tanstack-start-react, astro) | React hooks (see [API Reference](/docs/api/react-hooks))                                |
...
5. Writes the final versioned SW file (e.g. `dist/sw-v1.2.3.js`)
