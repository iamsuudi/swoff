...
- [Caching System architecture](/docs/architecture/caching) — strategy resolution, navigation modes, HTML cache isolation
- [Auth System architecture](/docs/architecture/auth) — adapter system, memory-only tokens, `clearAuth()` cascade
- [Data Sync architecture](/docs/architecture/data-sync) — batch refresh queue, request batching, mutation queue, dual-replay prevention
- [Observability architecture](/docs/architecture/observability) — fetch timeout, storage quota, unified notification channel
- [Optimistic Updates](/docs/architecture/optimistic-updates) — design rationale for exclusion
