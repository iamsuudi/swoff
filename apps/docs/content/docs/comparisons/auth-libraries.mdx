...
Identify your auth library's mechanism to know whether you need to configure `getHeaders()` in your [adapter](/docs/guides/auth#swoffauthadapterts---you-must-edit-this-file) or can skip it entirely.
...
- [Auth-Aware Caching guide](/docs/guides/auth) — full setup walkthrough
- [Config reference: auth](/docs/config#featuresauth) — all configuration options
- [Authentication comparison](/docs/comparisons/auth) — why auth awareness matters for cache security
