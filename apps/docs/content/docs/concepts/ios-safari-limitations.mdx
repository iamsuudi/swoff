...
- [Storage Quota Management](/docs/patterns/indexeddb-patterns#persistent-storage) — quota limits and eviction
- [Offline-First Architecture](/docs/core/offline-architecture) — build resilient for all platforms
