...
Instead of `/sw.js`, Swoff uses `/sw-v1.0.0.js`, `/sw-v1.0.1.js`, etc. Each version is a unique file. The browser only loads the version you tell it to.
...
- [PWA & Browser APIs](/docs/concepts/pwa-and-browser-apis) — the supporting stack
- [Versioned SW System](/docs/architecture/versioned-sw) — how we prevent silent updates
