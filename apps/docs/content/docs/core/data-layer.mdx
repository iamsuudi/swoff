...
- **Mutate + Sync:** [Mutation Queuing](/docs/advanced/mutation-queuing) — queue, reconcile, invalidate
- **Background Sync:** [Background Sync](/docs/advanced/background-sync) — SW-side sync with client notification
