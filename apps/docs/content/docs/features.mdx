...
| `crossTabSync` | `true` | Cross-tab cache invalidation (requires `tagInvalidation`) |
...
| **Standard** | Above + tagInvalidation + crossTabSync | Tag-based cache invalidation, cross-tab sync |
