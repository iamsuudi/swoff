...
flowchart TB
    Swoff["Swoff client-injector<br/>framework-agnostic"]
    Event["dispatches window custom events"]
    Adapter["Your adapter<br/>framework-specific"]
    Reactive["listens and exposes as reactive state"]
    UI["Your UI components"]

    Swoff --> Event --> Adapter --> Reactive --> UI

    style Swoff fill:#eff6ff,stroke:#3b82f6,stroke-width:1px,color:#1e40af
    style Event fill:#fef9c3,stroke:#eab308,stroke-width:1px,color:#854d0e
    style Adapter fill:#f0fdf4,stroke:#22c55e,stroke-width:1px,color:#166534
    style Reactive fill:#fef9c3,stroke:#eab308,stroke-width:1px,color:#854d0e
    style UI fill:#faf5ff,stroke:#a855f7,stroke-width:1px,color:#6b21a8
```
