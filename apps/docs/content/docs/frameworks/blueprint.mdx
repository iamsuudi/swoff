...
| --------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `useNetworkStatus`    | `app-connectivity-change`, `navigator.connection` `change`            | `online`, `wasOffline`, `lastChangedAt`, `effectiveType`, `downlink`, `isRetrying`, `retry` |
...
| `useOfflineAnalytics` | `swoff:offline-fallback` (or SW message `OFFLINE_FALLBACK_ACTIVATED`) | `lastEvent`, `events`, `clear`                                                              |
