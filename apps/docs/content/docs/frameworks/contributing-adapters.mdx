...
touch apps/docs/content/docs/frameworks/astro.mdx
```
...
Add SW registration to your layout or client-side script (see [Client Registration](/docs/cli/)):
...
- [Patterns](/docs/cli/) — all available patterns

````

### 3. Update meta.json

Add to `apps/docs/content/docs/frameworks/meta.json`:
...
2. **Link, don't repeat** — Reference `/docs/cli/*`, don't paste pattern code
...
- SW template code (link to [SW Template](/docs/architecture/architecture))
- Build script code (link to [Build Scripts](/docs/cli/))
- Client registration logic (link to [Client Registration](/docs/cli/))
- TypeScript declarations (link to [Utilities](/docs/cli/))
