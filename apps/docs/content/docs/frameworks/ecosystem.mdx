...
| ----------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| **Laravel / PHP**       | Place `swoff/` under `public/`, reference in Blade template                                    | [Laravel guide](/docs/frameworks/laravel/adapters)       |
| **Django**              | Place under `static/`, use `{% static %}` tag, or collect via `python manage.py collectstatic` | [Django & Flask guide](/docs/frameworks/django/adapters) |
| **Flask**               | Place under `static/`, reference via `url_for('static', ...)`                                  | [Django & Flask guide](/docs/frameworks/django/adapters) |
| **Rails**               | Place under `app/assets/` or `public/` with asset pipeline                                     | [Rails guide](/docs/frameworks/rails/adapters)           |
| **Go / net/http**       | Embed via `//go:embed swoff/*` or serve from a `static/` directory                             | [Go guide](/docs/frameworks/go/adapters)                 |
