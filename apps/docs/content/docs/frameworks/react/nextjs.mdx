...
| **Server Actions**       | Mutations always need network. Use [Offline Mutations](/docs/guides#mutation-queue) for queueing.                           |
...
- [Offline Mutations guide](/docs/guides#mutation-queue) — queue Server Actions when offline
