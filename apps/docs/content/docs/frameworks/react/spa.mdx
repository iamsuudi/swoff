...
| Setting                   | Value           | Why                                                                                        |
| ------------------------- | --------------- | ------------------------------------------------------------------------------------------ |
| `caching.navigation.mode` | `"spa"`         | Client router handles all navigation. SW serves app shell from precache for any route.     |
| `caching.strategy.default`| `"cache-first"` | All JS bundles and assets are hashed filenames — once cached, they never need the network. |
