...
Identify your auth library's mechanism to know whether you need to configure `withAuthHeaders()` in [Auth-Aware Fetch](/docs/future/authentication/auth-fetch) or can skip it entirely.
...
- **Configure your fetch**: [Auth-Aware Fetch](/docs/future/authentication/auth-fetch)
