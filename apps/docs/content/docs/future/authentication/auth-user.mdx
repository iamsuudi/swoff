...
**Prerequisites:** [Auth Store](/docs/future/authentication/auth-store), [Auth-Aware Fetch](/docs/future/authentication/auth-fetch).
...
- **Integrate with SW**: [SW Integration](/docs/future/authentication/sw-integration) — cache invalidation on logout
- **Handle offline states**: [Offline Auth State](/docs/future/authentication/offline-state) — four-state matrix
- **Add lock screen**: [Lock Screen](/docs/future/authentication/lock-screen) — PIN/biometric for fully offline apps
