...
**Prerequisites:** [Auth Store](/docs/future/authentication/auth-store), [Current User](/docs/future/authentication/auth-user).
...
- **Add local security**: [Lock Screen](/docs/future/authentication/lock-screen) — PIN/biometric for fully offline apps
- **Queue mutations**: [Mutation Queuing](/docs/future/mutation-queuing) — handle writes when offline
- **Review the SW integration**: [SW Integration](/docs/future/authentication/sw-integration)
