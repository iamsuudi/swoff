...
Identify your auth library's mechanism to know whether you need to configure `getHeaders()` in your [adapter](/docs/guides/auth#customize) or can skip it entirely.
