...
- `strategy.reactive.defaults.staleTime` — default: `0`.
- `strategy.reactive.defaults.refetchInterval` — default: `0` (no polling).
- `strategy.reactive.defaults.refetchOnReconnect` — default: `false`.
- `strategy.reactive.defaults.refetchOnFocus` — default: `false`.
