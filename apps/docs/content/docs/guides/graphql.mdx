...
- [Tag invalidation: auto-tags from operation names](/docs/guides/tag-invalidation)
- [Offline mutations: queue mutations offline](/docs/guides/offline-mutations)
- [Config reference: graphql](/docs/cli/config#featuresgraphql)
