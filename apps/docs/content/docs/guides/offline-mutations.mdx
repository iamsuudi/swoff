---
title: Offline Mutations & Background Sync
...
- [Full comparison: Offline queue](/docs/comparisons/offline-queue)
- [Auth guide: cookie vs bearer](/docs/guides/auth)
- [GraphQL: mutation auto-invalidation](/docs/guides/graphql)
- [Config reference: mutationQueue](/docs/cli/config#featuresmutationqueue)
