...
**If your framework already has this adapter** (React): the CLI generates `usePushSubscription` into `swoff/adapters/`. See the [React page](/docs/frameworks/react) for its API. To create adapters for any other framework, see the [Blueprint](/docs/frameworks/blueprint).
