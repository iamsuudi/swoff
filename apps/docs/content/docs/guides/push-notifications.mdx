...
- [Server push: real-time cache invalidation via SSE/WS](/docs/guides/server-push)
- [Caching strategies: how push interacts with caching](/docs/guides/caching-strategy)
- [Config reference: features](/docs/cli/config#featurespushnotifications)
