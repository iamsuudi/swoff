...
When the user goes offline, reads should serve from cache and mutations should be queued:
...
- Generate tags automatically from URLs: [Invalidation Tags](/docs/patterns/invalidation-tags)
- Set up cross-tab sync for cache invalidation across tabs
- Add offline mutation queuing: [Mutation Queuing](/docs/advanced/mutation-queuing)
