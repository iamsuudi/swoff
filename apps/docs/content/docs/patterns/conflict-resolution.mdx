...
**Prerequisites:** [Mutation Queuing](/docs/future/mutation-queuing) with ID reconciliation and `$synced` tracking.
...
- See [Mutation Queuing](/docs/future/mutation-queuing) — the queue that triggers conflict detection
...
- See [Testing](/docs/patterns/testing) — test conflict scenarios with fake-indexeddb
