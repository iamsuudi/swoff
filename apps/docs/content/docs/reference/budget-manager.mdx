...
1. **[Mutation Queuing](/docs/future/mutation-queuing)** — client-side queue patterns for when you add your own backend
2. **[Background Sync](/docs/future/background-sync)** — retry failed requests (client-side patterns)
3. **[Push Notifications](/docs/future/push-notifications)** — client-side subscription handling
