...
2. **IndexedDB** — all data stored locally, zero runtime deps
...
1. **[Mutation Queuing](/docs/advanced/mutation-queuing)** — client-side queue patterns for when you add your own backend
2. **[Background Sync](/docs/advanced/background-sync)** — retry failed requests (client-side patterns)
3. **[Push Notifications](/docs/advanced/push-notifications)** — client-side subscription handling
...
- Read [Concepts](/docs/concepts/what-is-offline-and-sw) to understand the architecture
