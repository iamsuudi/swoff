...
description: Shopping cart with offline storage, queued checkout, and authenticated user.
icon: ShoppingCart
---

## E-commerce Reference

A fully offline-ready e-commerce cart showing auth integration, cart persistence, and queued checkout.
...
- [Reference: Budget Manager](/docs/reference/budget-manager) — full offline app