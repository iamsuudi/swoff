          ...
          <div className="max-w-4xl mx-auto px-4 py-24">
            <div className="text-center mb-12">
              ...
              <p className="text-fd-muted-foreground max-w-xl mx-auto">
                Works with React, Vue, Svelte, or vanilla JS. We provide
                patterns, you choose the framework.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl border border-fd-border bg-fd-card/50">
                ...
                <p className="text-sm text-fd-muted-foreground mb-4">
                  Installable on all devices. Works like a native app, built
                  with web standards.
                </p>
                <Link
        ...
        <div className="border-t border-fd-border bg-fd-muted/30">
          <div className="max-w-4xl mx-auto px-4 py-16 text-center">
            ...
            <p className="text-fd-muted-foreground mb-8 max-w-xl mx-auto">
              Check out Budget Manager — a fully offline budget tracker built
              with Swoff patterns. 24+ routes, IndexedDB storage, versioned SW
              updates.
            </p>
            <Link
