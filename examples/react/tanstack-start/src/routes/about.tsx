    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          , a zero-dependency blueprint for versioned service workers with cache strategies, tag invalidation, and offline mutation queuing.
        </p>
        <p className="mb-6 text-gray-600 dark:text-gray-400 leading-relaxed">
          Browse Notes, create and edit them, then go offline — your changes are queued and sync automatically when the connection returns. The service worker caches API responses using
          <strong className="text-gray-900 dark:text-white"> network-first</strong> and purges stale entries via tag-based invalidation after every mutation.
        </p>
        ...
        <div className="mt-8 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">
            If something goes wrong — corrupted cache, stale state — use the reset button to wipe everything and start fresh.
          </p>
          <ResetButton />
        </div>
      </div>
